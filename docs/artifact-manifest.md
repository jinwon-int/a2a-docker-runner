...
- `evidenceHints`: compact PR/Done/Block URL hints for broker task-report recovery, including failureCategory values such as `timed_out`, `resource_limited`, or `exit_nonzero` for stability gates.
